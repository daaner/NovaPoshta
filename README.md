...
- [x] [Создать Контрагента](/docs/Counterparty.md#save)
- [ ] Создать контактное лицо Контрагента
- [x] [Создать Контрагента с типом (юридическое лицо) организация](/docs/Counterparty.md#save)
- [x] [Создать Контрагента с типом третьего лица](/docs/Counterparty.md#save)
- [x] [Загрузить список адресов Контрагентов](/docs/Counterparty.md#getCounterpartyAddresses)
- [x] [Загрузить параметры Контрагента](/docs/Counterparty.md#getCounterpartyOptions)
- [x] [Загрузить список контактных лиц Контрагента](/docs/Counterparty.md#getCounterpartyContactPerson)
- [x] [Загрузить список контрагентов](/docs/Counterparty.md#getCounterparties)
...
- [x] [Создать экспресс-накладную](/docs/InternetDocument.md#save)
- [x] [Создать экспресс-накладную на адрес](/docs/InternetDocument.md#save)
- [x] [Создать экспресс-накладную на отделение](/docs/InternetDocument.md#save)
- [x] [Создать экспресс-накладную на почтомат "Нова пошта"](/docs/InternetDocument.md#save)
- [x] [Создать экспресс-накладную с обратной доставкой](/docs/InternetDocument.md#save)
- [ ] Редактировать экспресс-накладную
- [x] [Получение полной инфо об ЭН](/docs/TrackingDocument.md#getStatusDocuments)
- [ ] Получить список ЭН
- [x] [Удалить экспресс-накладные](/docs/InternetDocument.md#delete)
