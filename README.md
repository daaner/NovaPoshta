...
- [x] Получение данных по картам оплаты, подключенным к системе
- [x] Получение списка доступных API ключей
- [x] Продление действия API ключа
- [x] Получение списка доверенных устройств
- [x] Удаление доверенного устройства
- [x] Получение данных о входящих посылках
- [x] Получение активных промокодов прикрепленных к телефону контрагента
- [x] Список данных по бонусной программе контрагента
- [x] Список материальных ценностей доступных для заказа
- [x] Список заказанных материальных ценностей
- [x] Получение списка ордеров для заказа авто
- [x] Создание API ключа
- [x] Удаление API ключа
- [x] Замена/снятие наложного платежа
...
- [x] Маркировки - печатная форма
- [x] Реестры - печатная форма
- [x] Экспресс-накладная - печатные формы
...
- [x] Проверка возможности создания заявки по изменению данных
